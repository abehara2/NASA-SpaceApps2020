    ...
    return(
        <div >
              ...
              <iframe
                  ...
                  style={{ height: "500px", width: "80%", marginLeft: "10%", marginRight: "10%", marginTop: "2.5%", borderRadius: "1%"}}
                >
                  <MapContainer style={{ float: 'center' }} />
                </iframe>
                <Button animated style={{width: "10%"}} onClick={() => Notiflix.Notify.Success('Just Testing Notiflix')}>
